...
async def run():
    ...
    async for terrain_info in drone.telemetry.home():
        ...
        break
    flying_alt = absolute_altitude + 2.0
    ...
    await drone.action.goto_location(object_lat, object_lon, 62+15, float('nan'))
    ...
    async for position in drone.telemetry.position():
        ...
        if (object_lat - 0.00005 <= lat <= object_lat + 0.00005) and (
            ...
            await drone.action.goto_location(object_lat, object_lon, 62+15, 0)
